        ...
        for(let i =5; i<8; i++){
            ...
            for(let i =0; i<forNameOfCollections.length; i++){
                ...
                await collection.aggregate([
                    ...
                    { $project: { 
                        ChrType :1, AccessType: 1, ProtocolCause: 1, "Procedure identification": 1, fieldName:"Handover Cancel Phase","Handover Cancel Phase":1,
                        StartTime:  { 
                    ...
                    {$group:{
                            ...
                            "name":{ "$first":"$Handover Cancel Phase"},
