        ...
        for(let i =5; i<8; i++){
            ...
            for(let i =0; i<forNameOfCollections.length; i++){
                ...
                await collection.aggregate([
                    ...
                    { $project: { 
                        ChrType :1, AccessType: 1, ProtocolCause: 1, "Procedure identification": 1, fieldName:"GGSN Address for user traffic","GGSN Address for user traffic":1,
                        StartTime:  { 
                    ...
                    {$group:{
                            ...
                            "name":{ "$first":"$GGSN Address for user traffic"},
